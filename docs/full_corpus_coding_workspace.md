...
The current local workspace is `full-coding-e0192ecbd9e4`. It is derived from the committed
`full_corpus_coding_v4` seed release and the complete 197-session FastF1 review context.

| Item | Value |
|---|---:|
| Document dispositions | 2,003 |
| Adjudication starter instances | 1,952 |
| Stratified exclusion-QA rows | 486 |
| Timing sessions | 197 |
| Driver classifications | 3,938 |
| Protected seed-manifest SHA-256 | `540082201d4bf4ec98ecbc8f3e26ce17e6c17d883ff017a6fd753204cd4830a5` |
| Timing-context SHA-256 | `3227b6dac56635caa08a71a9ba789cecc59bb4557786749d9f997d9531e35264` |
| Workspace-content SHA-256 | `dec10c707f4e9fa262a3b4f1bfc439fba0cbd73737caf8a7f918aa8e186ea618` |
...
`exclusion_qa_worklist.csv` freezes the 486 hash-selected checks across all 272 proposed-exclusion
...
classification: 296 of 296 for each control. Secondary qualifying-impeding cases intentionally lack
...
|---|---:|---:|
| Parsed decision heading | 1,654 | 295 |
