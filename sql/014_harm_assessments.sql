CREATE TABLE IF NOT EXISTS curated.harm_assessments (
    ...
    position_window_start_lap INTEGER,
    position_window_end_lap INTEGER,
    relative_time_comparator_driver_number INTEGER,
    affected_relative_time_loss_seconds DOUBLE,
    relative_time_window_start_lap INTEGER,
    relative_time_window_end_lap INTEGER,
