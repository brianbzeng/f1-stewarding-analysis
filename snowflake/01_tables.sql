...
CREATE TABLE IF NOT EXISTS CURATED.HARM_ASSESSMENTS (
    ...
    POSITION_WINDOW_START_LAP NUMBER(4, 0),
    POSITION_WINDOW_END_LAP NUMBER(4, 0),
    RELATIVE_TIME_COMPARATOR_DRIVER_NUMBER NUMBER(3, 0),
    AFFECTED_RELATIVE_TIME_LOSS_SECONDS FLOAT,
    RELATIVE_TIME_WINDOW_START_LAP NUMBER(4, 0),
    RELATIVE_TIME_WINDOW_END_LAP NUMBER(4, 0),
...
CREATE TABLE IF NOT EXISTS CURATED.INCIDENT_LOCATIONS (
    ...
    TURN_START_NUMBER NUMBER(4, 0),
    TURN_END_NUMBER NUMBER(4, 0),
...
CREATE TABLE IF NOT EXISTS CURATED.INCIDENT_RELATIONS (
    ...
    SOURCE_DRIVER_NUMBER NUMBER(3, 0) NOT NULL,
    TARGET_DRIVER_NUMBER NUMBER(3, 0) NOT NULL,
...
CREATE TABLE IF NOT EXISTS CURATED.CROSS_EVENT_SANCTION_EFFECTS (
    ...
    DRIVER_NUMBER NUMBER(3, 0) NOT NULL,
    SANCTION_TYPE VARCHAR NOT NULL,
    NOMINAL_GRID_PLACES NUMBER(3, 0) NOT NULL,
    QUALIFYING_POSITION NUMBER(3, 0) NOT NULL,
    STARTING_GRID_POSITION NUMBER(3, 0) NOT NULL,
    REALIZED_GRID_PLACES_LOST NUMBER(3, 0) NOT NULL,
